...
class AppColors {
  ...
  static const Color backgroundDarkGrey = Color(0xFFD9D9D9);

  static const Color primaryBlue = Color(0xFF1877F2);
  static const Color primaryWhite = Color(0xFFFFFFFF);
  static const Color primaryBlack = Color(0xFF000000);
  static const Color primaryGrey = Color(0xFF7D848D);
  static const Color primaryRed = Color(0xFFF50000);
  static const Color primaryGreen = Color(0xFF77CC00);
  static const Color primaryOrange = Color(0xFFFF7029);
  static const Color primaryYellow = Color(0xFFFFD336);

  static const Color secondaryBlue = Color(0xFF66B2FF);
  static const Color secondaryGrey = Color(0xFFC4C4C4);

  static const Color textBlack = Color(0xFF1B1E28);
  ...
  static const Color amber600 = Color(0xFFFFA000);
  static const Color amber700 = Color(0xFFFF8F00);
  static const Color amber800 = Color(0xFFFF6F00);
