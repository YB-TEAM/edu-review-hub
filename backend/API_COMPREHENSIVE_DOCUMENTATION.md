...
| `POST`   | `/universities/:id/upload-image`                | Upload ảnh trường với metadata | Admin+     |
| `GET`    | `/universities/:id/images`                      | Lấy tất cả ảnh của trường      | Public     |
| `GET`    | `/universities/:id/images/primary/:type`        | Lấy ảnh chính theo loại        | Public     |
| `PATCH`  | `/universities/:id/images/:imageId`             | Cập nhật metadata ảnh          | Admin+     |
| `DELETE` | `/universities/:id/images/:imageId`             | Xóa ảnh trường                 | Admin+     |
| `POST`   | `/universities/:id/images/:imageId/set-primary` | Đặt ảnh làm chính              | Admin+     |
| `GET`    | `/universities/:id/images/stats`                | Thống kê ảnh trường            | Admin+     |
